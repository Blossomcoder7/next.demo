      ...
      <div className="flex gap-3">
        <div className="flex-1">
          <input
            ...
            className="w-full bg-[#262626] border border-[#d9b989] rounded-lg px-4 py-3 text-[#d9b989] placeholder-[#d9b989] outline-none focus:ring-2 focus:ring-[#d9b989] transition"
          />
          {errors.firstName && (
